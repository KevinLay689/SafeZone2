...
public class MainActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if(imp2) {
                    Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                            Uri.parse("http://maps.google.com/maps?saddr=" + latitudeNetwork + "," + longitudeNetwork + "&daddr=" + s2Info.get(it).lat + "," + s2Info.get(it).lng));
    ...
    public void startReport() {
        ...
        g1.execute("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+latitudeNetwork+","+longitudeNetwork+"&radius=2000&type=hospital&key=AIzaSyBJz3lvS2a1Si-QfmkrNxH1aY-5mMz8feA");
